def start():
	...
	print "In MM you can’t really choose your own path, but you can select what the actual myth is. "
	print "If you fail to go by the actual myth, then you will be reset back to start of the decision. "
	print "Let's go!"
	skip = "bleh"
...
def des6():
	...
	if ans == "2":
		print "Wrong! Why would you even think that that is the myth???"
		des6()
	elif ans == "1":
...
def des7_stry():
	...
	print "However, Perseus, being poor, had not brought anything, and you pretend to be furious. After a heated discussion, Perseus said he would bring you anything you would ask"
...
def des7():
	...
	print " "
	print "You set forth on your adventure. After woadering for days searching for the Gorgons' lair. You are beginning to feel hopeless. "
...
def des8():
	...
	if ans == "1":
		...
		print "Correct answer!"
		print "You believe that they say and they help you with your quest. Hermes gives you his winged sandals and his staff to kill Medusa. Athena gives you her shield. It will yield helpful because you won't have to risk looking into Medusa's eyes."
		des9_stry()
	elif ans == "skip":
		bleh()
	else:
...
def end():
	...
	print "You are furious, so you ask Dictys to take care of Andromeda, in order to avenge for your mother's mistreatment. "
	print "You storm to the palace, walk in and say, 'Let all who are my friends shield their eyes!' After saying this you raised Medusa's head and Polydectes and his courtiers were immediately turned to stone. You and Andromeda lived happily for many years and your descendants became great kings, the greatest of them all being Heracles, the strongest man in the world."
	print " "
	raw_input(" ")
	print "You are now playing the role of yourself."
	print " "
	print "Eventually, Perseus was killed by Dionysus. To be immortalised, Perseus and Andromeda were turned into stars and would live together in the sky."
	endend()
def endend():
